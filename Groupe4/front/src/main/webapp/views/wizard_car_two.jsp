...
<form:form method="POST" action="/wizard/car/3" modelAttribute="model">
    ...
    <div class="col-md-12">
        ...
        <form:input path="quoteCar.dateLicence" class="col-md-6" type="date" placeholder="12/02/02"/>
    </div>
    <div>
        <label class="col-md-6">Nombre d'accident</label>
        <form:input path="quoteCar.numberAccident" class="col-md-6" required="required" type="number" placeholder="2"/>
    </div>
    <div>
        <label class="col-md-6">Bonus / Malus</label>
        <form:input path="quoteCar.bonusMalus" class="col-md-6" required="required" type="number" placeholder="0.5"/>
    </div>
