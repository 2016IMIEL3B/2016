            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <form:input  path="address.number" class="form-control" cssStyle="width:250px;" required="required"></form:input>
                    </div>

                    <div class="form-group">
                        <form:label path="" for="quote.habitation.address.street"> Nom de rue </form:label>
                        <form:input  path="address.street" class="form-control" cssStyle="width:250px;" required="required"></form:input>
                    </div>

                    <div class="form-group">
                        <form:label path="" for="quote.habitation.address.postcode"> Code postal </form:label>
                        <form:input  path="address.postcode" class="form-control" cssStyle="width:250px;" required="required"></form:input>
                    </div>

                    <div class="form-group">
                        <form:label path="" for="quote.habitation.address.city"> Ville </form:label>
                        <form:input  path="address.city" class="form-control" cssStyle="width:250px;" required="required"></form:input>
                    </div>
